...
Markovian Music is a research project aimed at answering the question "Can computers create beautiful music?" 
This project applies the principles of Markov Chains to note sequences in music in order to create new music based on existing music.
